...
{
    const APSIS_CART_CHECKOUT_ENDPOINT = 'apsis/abandoned/checkout';
    ...
    public function getUrlForCheckoutLink(): string
    {
        ...
        try {
            $storeId = $this->cart->getStoreId();
            return $this->_storeManager->getStore($storeId)->getUrl(self::APSIS_CART_CHECKOUT_ENDPOINT, $params);
        } catch (Throwable $e) {
            $this->apsisLogHelper->logError(__METHOD__, $e);
            return $this->getUrl(self::APSIS_CART_CHECKOUT_ENDPOINT, $params);
        }
    }
}
