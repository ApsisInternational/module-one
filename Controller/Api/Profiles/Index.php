...
{
    const ENUM_UNIX_S = 'Epoch Timestamp (s)';
    /**
    ...
    const SCHEMA = [
        ...
        'date_of_birth' =>
            ['code_name' => 'date_of_birth', 'type' => self::ENUM_UNIX_S, 'display_name' => 'Date Of Birth'],
        ...
        'created_at' => ['code_name' => 'created_at', 'type' => self::ENUM_UNIX_S, 'display_name' => 'Created At'],
        'last_login_date' =>
            ['code_name' => 'last_login_date', 'type' => self::ENUM_UNIX_S, 'display_name'=>'Last Login Date'],
        ...
        'last_product_review_date' =>
            [
                'code_name' => 'last_product_review_date',
                'type' => self::ENUM_UNIX_S,
        ...
        'last_order_date' =>
            ['code_name' => 'last_order_date', 'type' => self::ENUM_UNIX_S, 'display_name' => 'Last Order Date'],
        'last_order_value' =>
